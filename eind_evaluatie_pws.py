# -*- coding: utf-8 -*-
"""eind model en evaluatie pws.ipynb
...
#opt = keras.optimizers.SGD(lr=0.015, momentum=0.9) of opt = keras.optimizers.SGD() of opt = tf.keras.optimizers.Adam(learning_rate=.001, beta_1=0.9)
